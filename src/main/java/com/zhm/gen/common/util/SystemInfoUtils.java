...
public class SystemInfoUtils {
    ...
    public static JSONObject getJvmInfo() {
        ...
        //jdk启动时间
        cpuInfo.put("jdkStartTime", getJvmInfoStartTime());
        //jdk运行时间
        cpuInfo.put("jdkRuntime", getJvmInfoRunTime());
        return cpuInfo;
    }
     ...
     * JDK启动时间
     */
    private static String getJvmInfoStartTime() {
     ...
     * JDK运行时间
     */
    private static String getJvmInfoRunTime() {
