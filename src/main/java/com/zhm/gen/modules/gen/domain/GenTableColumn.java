package com.zhm.gen.modules.gen.domain;
...
public class GenTableColumn extends BaseDomain {
    ...
    /** JAVA字段名首字母大写 */
    private String javaFieldCap;

    public String getJavaFieldCap() {
        if (StringUtils.isNotBlank(javaField)){
            char[] cs=javaField.toCharArray();
            cs[0]-=32;
    ...
    public void setJavaFieldCap(String javaFieldCap) {
        this.javaFieldCap = javaFieldCap;
    }
