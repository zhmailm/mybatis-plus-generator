layui.define(["jquery","layer"], function (exports) {
	...
	theme.colorSet = function(color) {
		...
		style +=' .avatar{width: 35px;height: 35px;border-radius: 50px;margin-right: 5px;background: '+ color + '!important}';
		style +=' .avatar1{width: 115px;height: 115px;border-radius: 50px;background: '+ color + '!important}';
		if(this.autoHead){
